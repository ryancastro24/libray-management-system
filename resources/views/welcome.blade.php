...
<html lang="en">
    ...
    <body>
        ...
        <!-- background image -->
        <img class="bg-image" src="assets/img/CSU lib.jpg" alt="background image">
        ...
        <div class="masthead">
            <div class="masthead-content text-white">
                <div class="container-fluid px-4 px-lg-0">
                    <h1 class="fst-italic lh-1 mb-4">Welcome to <br> Caraga State University Library</h1>
                    <p class="mb-5">"Reading is the key that unlocks the door to endless learning"</p>
